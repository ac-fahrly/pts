...
export const alt = 'PTS — Software for passenger transport: dispatch & work-time';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          >
            Dispatch and work-time. One system.
          </div>
          <div
            style={{
              display: 'flex',
          ...
          >
            For chauffeur, taxi and medical transport fleets. From 39 € per vehicle.
          </div>
        </div>
